...
```{r}
list(alternatives_chr = c("Social Anxiety App A", "Social Anxiety App B", "Do not use a social anxiety app"),
     ...
     opt_out_1L_lgl = T) -> dce_design_ls$choice_sets_ls 
```
...
dce_design_ls$block_indcs_ls = list(as.integer(c(3,5,6,7,8,9,12,14,15,18,19,20,23,24,28)), 
